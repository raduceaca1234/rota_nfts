          ...
          <Slider {...settings}>
            <CustomSlide className='itm' index={1}>
              <div className="nft_coll">
                  ...
                  <div className="nft_coll_info">
                      <span onClick={()=> window.open("/home", "_self")}><h4>Partner 1</h4></span>
            ...
            <CustomSlide className='itm' index={2}>
              <div className="nft_coll">
                  ...
                  <div className="nft_coll_info">
                      <span onClick={()=> window.open("/#", "_self")}><h4>Partner 2</h4></span>
            ...
            <CustomSlide className='itm' index={3}>
              <div className="nft_coll">
                  ...
                  <div className="nft_coll_info">
                      <span onClick={()=> window.open("/#", "_self")}><h4>Partner 3</h4></span>
            ...
            <CustomSlide className='itm' index={4}>
              <div className="nft_coll">
                  ...
                  <div className="nft_coll_info">
                      <span onClick={()=> window.open("/#", "_self")}><h4>Partner 4</h4></span>
            ...
            <CustomSlide className='itm' index={5}>
              <div className="nft_coll">
                  ...
                  <div className="nft_coll_info">
                      <span onClick={()=> window.open("/#", "_self")}><h4>Partner 5</h4></span>
            ...
            <CustomSlide className='itm' index={6}>
              <div className="nft_coll">
                  ...
                  <div className="nft_coll_info">
                      <span onClick={()=> window.open("/#", "_self")}><h4>Partner 6</h4></span>
